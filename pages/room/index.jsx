    ...
    return (
        <Container className={classNames(styles["container-wrapper"])}>
            ...
            <Grid container className={classNames(styles["grid-wrapper"])}>
                <Grid item xs={12} className={classNames(styles["header-container"])}>
                    <Header left={room} />
                </Grid>
                <Grid item xs={6}>
                    <Typography variant="h4" className={classNames(styles["title"])}>Devices</Typography>
                    <Devices devices={[{ iconUrl: "/images/bulb.svg", title: "off" }, { iconUrl: "/images/bulb.svg", title: "off" }, { iconUrl: "/images/bulb.svg", title: "off" }, { iconUrl: "/images/bulb.svg", title: "off" }, { iconUrl: "/images/bulb.svg", title: "off" }]} />
                </Grid>
                <Grid item xs={6}>
